...
<div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top bg-primary">
        <div class="container">
            <a class="navbar-brand d-block d-md-none" href="#">{{env('app_name')}}</a>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="#">Khóa học đang giảm giá</a></li>
                            <li><a class="dropdown-item" href="#">Khóa học online</a></li>
                            <li class="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle dropright  " href="#">Khóa học Tiếng Anh</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">Tiếng Anh với Người Mỹ</a></li>
                                    <li><a class="dropdown-item" href="#">Tiếng Anh với người Philipin</a></li>
                                    <li><a href="#" class="dropdown-item">Tiếng Anh với người Việt Nam</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
